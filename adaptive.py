...
def pre_adaptive_f(feat, phi, q, n, mG, alpha, min_q=5, seed=1):
    """Prepare gradient map f for adaptive kernel and calculate
    ...
    Arguments:
        ...
        q:      top-q eigensystem for constructing adaptive kernel.
    ...
    Returns:
        ...
        beta:   largest k(x, x) for the adaptive kernel.
    """
...
def asm_adaptive_f(pre_f, kfeat, inx):
    """Assemble map for adaptive kernel"""
    def adaptive_f(p, g, eta):
    ...
    def __init__(self, kernel, centers, n_label, mem_gb,
        ...
        model.compile(
            ...
            optimizer=PSGD(pred_t=y, index_t=index, eta=eta,
                           adaptive_f=asm_adaptive_f(kf, kfeat, pinx)),
            metrics=[metric])
